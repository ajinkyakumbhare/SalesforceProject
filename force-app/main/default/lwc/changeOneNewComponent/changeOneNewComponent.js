...
import NAMECONTACT_FIELD from '@salesforce/schema/Contact.Name';
...
dateTimeFieldValueEnd;
    ...
    handleTrainerChange(event) {
        this.rec.Trainer__c = event.target.value;
        console.log("name5", this.rec.Trainer__c);
    }
    ...
    handleContactNameChange(event) {
        ...
        console.log("name2", this.rec.Name);
    }
